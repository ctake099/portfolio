...
export default function Blog({ posts }) {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-left flex items-center justify-start text-purple-600 dark:text-purple-400">
        Blog
      </h1>
        ...
        {posts.map((post, index) => (
          <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
            ...
            <Link href={`/blog/${post.slug}`}>
              <a className="inline-block text-blue-600 dark:text-blue-400 hover:underline transition-colors duration-200">
                続きを読む
              </a>
            </Link>
          </div>
